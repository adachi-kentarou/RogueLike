...
namespace Map.Model
{
    ...
    partial class MapModel
	{
		...
		private bool CreateRoadStairsGround(CellData a_data, Point a_point, GameObject a_parent)
		{
			...
			//部屋天井
			if (a_data.m_up != ConnectType.CONNECT)
			{
				CreateCellObject(ObjeType.ROOM_CELLING, Map.Direction.RIGHT, a_data, a_point, a_parent);
			}
