...
namespace Map.Model
{
    ...
    partial class MapModel
	{
        ...
        private bool CreateRoadCeiling(CellData a_data, Point a_point, GameObject a_parent)
        {
			//道天井
            ...
            var t_obj = CreateCellObject(ObjeType.ROAD_CEILING, Map.Direction.RIGHT, a_data, a_point, a_parent);
