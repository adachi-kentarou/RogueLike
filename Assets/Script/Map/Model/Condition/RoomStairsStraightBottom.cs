...
namespace Map.Model
{
    ...
    partial class MapModel
	{
		...
		private bool CreateRoomStairsStraightBottom(CellData a_data, Point a_point, GameObject a_parent)
		{
			//直線階段判定
			...
			var t_obj = CreateCellObject(ObjeType.ROOM_STAIRS_STRAIGHT, t_connect_direction_down, a_data, a_point, a_parent);
